  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Barlow_Condensed:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[40px] lg:text-[88px] text-white tracking-[2px] lg:tracking-[4px] uppercase w-full">
        <h1 className="block leading-none whitespace-pre-wrap" data-hero-headline>No vendemos metros</h1>
      </div>
      <Frame40 />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-center min-h-px min-w-px relative" data-name="Text">
      ...
      <div className="flex flex-col font-['Barlow_Semi_Condensed:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] lg:text-[30px] text-white tracking-[-1px] lg:tracking-[-2px] uppercase w-full">
        <p className="leading-[0.9] whitespace-pre-wrap" data-hero-subtitle>El real estate volvió a ser negocio.</p>
      </div>
    </div>
  );
}
...
function PrimaryButton() {
  return (
    <a href="https://wa.me/5491173646541" target="_blank" rel="noopener noreferrer" className="bg-white content-stretch flex h-[48px] items-center justify-center px-[25px] py-[12px] relative rounded-[999px] shrink-0 w-full sm:w-[265px] no-underline cursor-pointer hover:bg-gray-100 transition-colors" data-name="Primary button" data-hero-cta>
...
function Logos() {
  return (
    <div className="hidden lg:flex absolute content-stretch flex-col gap-[16px] items-start left-[32px] top-[136px] w-[113px]" data-name="Logos" data-hero-logo>
      <Row4 />
      <Row5 />
      <Row6 />
    </div>
...
export default function HeroSection() {
  ...
  return (
    <div ref={heroRef} className="h-[100svh] lg:h-[640px] overflow-clip relative shrink-0 w-full" data-name="Hero" id="inicio">
      <video aria-label="Logo on colored background" autoPlay className="absolute max-w-none object-cover size-full" controlsList="nodownload" loop muted playsInline poster={`${import.meta.env.BASE_URL}images/hero-poster.jpg`} preload="metadata" data-hero-bg>
